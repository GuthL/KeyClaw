...
fn summarize_audit_log_aggregates_redactions_by_rule_and_host() {
    ...
    std::fs::write(
        ...
        concat!(
            ...
            "{\"ts\":\"2026-03-10T00:00:01Z\",\"rule_id\":\"generic-api-key\",\"request_host\":\"api.openai.com\",\"action\":\"redacted\"}\n",
            "{\"ts\":\"2026-03-10T00:00:02Z\",\"rule_id\":\"aws-access-key\",\"request_host\":\"api.openai.com\",\"action\":\"redacted\"}\n"
        ),
    )
    ...
    assert_eq!(summary.top_rules[0].name, "generic-api-key");
    assert_eq!(summary.top_rules[0].count, 2);
    assert_eq!(summary.top_rules[1].name, "aws-access-key");
